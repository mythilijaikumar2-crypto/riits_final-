...
import { CONTACT_DETAILS, formatTelLink, getMailtoLink, COMPANY_NAME, BRAND_NAME } from "../config/contact";
  ...
  <footer className="bg-slate-950 text-white">
    <div className="container-main section-padding">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        <div>
          <h3 className="font-heading text-xl font-bold uppercase mb-4">{BRAND_NAME} Metal Craft</h3>
        ...
        <div>
          ...
          <div className="flex flex-col gap-3 text-sm">
            ...
            <a href={formatTelLink(CONTACT_DETAILS.primaryPhone.value)} className="flex items-center gap-2 opacity-80 hover:opacity-100 transition-opacity" aria-label="Call RIITS Metal Craft">
              ...
              <span>{CONTACT_DETAILS.primaryPhone.display}</span>
            </a>
