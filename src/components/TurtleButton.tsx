  ...
  "relative inline-flex items-center justify-center gap-2 overflow-hidden rounded-lg font-heading font-semibold uppercase tracking-wider text-sm transition-all duration-300 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        whatsapp: "bg-[hsl(142,70%,40%)] text-white hover:shadow-xl hover:shadow-[hsl(142,70%,40%)]/25",
        ...
        index_brand_shimmer: "bg-gradient-to-r from-amber-600 via-amber-500 to-orange-600 text-[#0d151f] shadow-[0_0_20px_rgba(245,158,11,0.2)] hover:shadow-[0_0_30px_rgba(245,158,11,0.5)]",
